...
if (document.querySelector('.programs__block')) {
}
let programSlaider = new Swiper('.programs__slaider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
//=====================================================================
if (document.querySelector('.examples__block')) {
}
let examplesSlider = new Swiper('.examples__slider', {
	...
	*/
	...
	navigation: {
		nextEl: '.slide-examples__arrow_next',
		prevEl: '.slide-examples__arrow_prev',
	},
...
let textareaLabel = document.querySelector('.textarea__label');

textareaInput.addEventListener("click", someClick);
...
textareaInput.addEventListener("click", function (e) {
	textareaLabel.classList.add('_active');
});

document.documentElement.addEventListener("click", function (e) {
	if (!e.target.closest('.textarea__input')) {
		textareaLabel.classList.remove('_active');
	}
});
*/
